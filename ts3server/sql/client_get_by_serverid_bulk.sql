 ...
 select client_id as id, 'client_lastconnected' as ident, client_lastconnected as value from clients  where server_id=:server_id: union
 select client_id as id, 'client_totalconnections' as ident, client_totalconnections as value from clients  where server_id=:server_id: union
